  ...
  return (
    <div className="mt-3">
      ...
      {expensesList && expensesList.length > 0 ? (
        <>
          <div className="grid grid-cols-4 rounded-tl-xl rounded-tr-xl bg-slate-200 dark:bg-slate-800 p-2 mt-3">
          ...
          {expensesList.map((expenses) => (
            <div
              ...
              className="grid grid-cols-4 bg-slate-50 dark:bg-slate-900 border-b dark:border-slate-800 p-2 items-center"
            >
              <h2>{expenses.name}</h2>
